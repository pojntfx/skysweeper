export const PrivacyPolicy = () => (
  <>
    <p>
      ...
      Felicitas Pojtinger. The use of the Internet pages of the Felicitas
      Pojtinger is possible without any indication of personal data; however, if
    ...
    <p>
      ...
      Felicitas Pojtinger. By means of this data protection declaration, our
    ...
    <p>
      As the controller, the Felicitas Pojtinger has implemented numerous
    ...
    <p>
      The data protection declaration of the Felicitas Pojtinger is based on the
    ...
    <ul>
      ...
      <li>
        <h4 id="g-controller-or-controller-responsible-for-the-processing">
    ...
    <h4 id="2-name-and-address-of-the-controller">
    ...
    <h4 id="4-collection-of-general-data-and-information">
      4. Collection of general data and information
    </h4>
    <p>
      The website of the Felicitas Pojtinger collects a series of general data
    ...
    <p>
      When using these general data and information, the Felicitas Pojtinger
      ...
      Therefore, the Felicitas Pojtinger analyzes anonymously collected data and
    ...
    <h4 id="5-registration-on-our-website">5. Registration on our website</h4>
    <p>
    ...
    <h4 id="6-routine-erasure-and-blocking-of-personal-data">
    ...
    <h4 id="7-rights-of-the-data-subject">7. Rights of the data subject</h4>
    <ul>
      <li>
      ...
      <li>
        <h4 id="d-right-to-erasure-right-to-be-forgotten-">
        ...
        <p>
          ...
          wishes to request the erasure of personal data stored by the Felicitas
          Pojtinger, he or she may, at any time, contact any employee of the
          controller. An employee of Felicitas Pojtinger shall promptly ensure
        ...
        <p>
          ...
          required. An employees of the Felicitas Pojtinger will arrange the
          necessary measures in individual cases.
        </p>
      </li>
      <li>
        <h4 id="e-right-of-restriction-of-processing">
        ...
        <p>
          ...
          stored by the Felicitas Pojtinger, he or she may at any time contact
          any employee of the controller. The employee of the Felicitas
          Pojtinger will arrange the restriction of the processing.
        </p>
      </li>
      <li>
        ...
        <p>
          ...
          at any time contact any employee of the Felicitas Pojtinger.
        </p>
      </li>
      <li>
        ...
        <p>
          The Felicitas Pojtinger shall no longer process the personal data in
        ...
        <p>
          If the Felicitas Pojtinger processes personal data for direct
          ...
          to such direct marketing. If the data subject objects to the Felicitas
          Pojtinger to the processing for direct marketing purposes, the
          Felicitas Pojtinger will no longer process the personal data for these
          purposes.
        </p>
        <p>
          ...
          data concerning him or her by the Felicitas Pojtinger for scientific
        ...
        <p>
          ...
          any employee of the Felicitas Pojtinger. In addition, the data subject
      ...
      <li>
        <h4 id="h-automated-individual-decision-making-including-profiling">
        ...
        <p>
          ...
          it is based on the data subject&#39;s explicit consent, the Felicitas
          Pojtinger shall implement suitable measures to safeguard the data
        ...
        <p>
          ...
          employee of the Felicitas Pojtinger.
        </p>
      </li>
      <li>
        <h4 id="i-right-to-withdraw-data-protection-consent">
    ...
    <h4 id="8-legal-basis-for-the-processing">
    ...
    <h4 id="9-the-legitimate-interests-pursued-by-the-controller-or-by-a-third-party">
    ...
    <h4 id="10-period-for-which-the-personal-data-will-be-stored">
    ...
    <h4 id="11-provision-of-personal-data-as-statutory-or-contractual-requirement-requirement-necessary-to-enter-into-a-contract-obligation-of-the-data-subject-to-provide-the-personal-data-possible-consequences-of-failure-to-provide-such-data">
    ...
    <h4 id="12-existence-of-automated-decision-making">
    ...
    <p>
      ...
      <a href="https://abletocontract.com/">smart agreements</a>. The legal
      ...
      <a href="https://www.wbs-law.de/">Christian Solmecke</a> from WBS law.
    </p>
  </>
);
